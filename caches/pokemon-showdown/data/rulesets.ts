...
export const Rulesets: {[k: string]: FormatData} = {
	...
	standarddoubles: {
		...
		ruleset: [
			'Obtainable', 'Species Clause', 'Nickname Clause', 'OHKO Clause', 'Evasion Moves Clause', 'Gravity Sleep Clause', 'Endless Battle Clause', 'HP Percentage Mod', 'Cancel Mod', //'Team Preview'
			'Min Source Gen = 9',
		],
	},
	standardoms: {
