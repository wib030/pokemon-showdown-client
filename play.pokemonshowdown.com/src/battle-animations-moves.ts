...
export const BattleMoveAnims: AnimTable = {
	...
	orderup: {
		anim(scene, [attacker, defender]) {
			const tatsugiriSprite = {
				url: `https://wib030.github.io/pokemon-sprites/sprites/gen5/tatsugiri${['-droopy', '-stretchy', ''][Math.floor(Math.random() * 3)]}.png`,
				w: 96,
				h: 96,
			};
	...
	sheercold: { // Reminder: Improve this later
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('https://wib030.github.io/pokemon-sprites/sprites/gen6bgs/bg-icecave.jpg')`, 1000, 0.6);
			scene.showEffect('icicle', {
				x: defender.x,
				y: defender.y,
				z: defender.z,
	...
	plasmafists: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('https://wib030.github.io/pokemon-sprites/sprites/gen6bgs/bg-earthycave.jpg')`, 2000, 1);
	...
	splinteredstormshards: {
		anim(scene, [attacker, defender]) {
			scene.backgroundEffect(`url('https://wib030.github.io/pokemon-sprites/sprites/gen6bgs/bg-earthycave.jpg')`, 2700, 0.8, 300);
	...
	clangoroussoulblaze: {
		anim(scene, [attacker, ...defenders]) {
			...
			scene.backgroundEffect(`url('https://wib030.github.io/pokemon-sprites/sprites/gen6bgs/bg-earthycave.jpg')`, 2000, 0.7, 300);
...
BattleMoveAnims['tossandturn'] = { anim: BattleMoveAnims['struggle'].anim };
BattleMoveAnims['psychicscream'] = { anim: BattleMoveAnims['psychicnoise'].anim };
BattleMoveAnims['peekaboo'] = { anim: BattleMoveAnims['hex'].anim };
BattleMoveAnims['hailcannon'] = { anim: BattleMoveAnims['iciclecrash'].anim };
BattleMoveAnims['peatslide'] = { anim: BattleMoveAnims['earthpower'].anim };
BattleMoveAnims['firechase'] = { anim: BattleMoveAnims['blastburn'].anim };
BattleMoveAnims['nibble'] = { anim: BattleMoveAnims['bugbite'].anim };
BattleMoveAnims['goldenbinding'] = { anim: BattleMoveAnims['lusterpurge'].anim };
BattleMoveAnims['lovelypunch'] = { anim: BattleMoveAnims['dizzypunch'].anim };
BattleMoveAnims['mindvirus'] = { anim: BattleMoveAnims['eeriespell'].anim };
BattleMoveAnims['tantrum'] = { anim: BattleMoveAnims['flail'].anim };
BattleMoveAnims['plow'] = { anim: BattleMoveAnims['pound'].anim };
BattleMoveAnims['snap'] = { anim: BattleMoveAnims['bite'].anim };
BattleMoveAnims['chumrush'] = { anim: BattleMoveAnims['aquajet'].anim };
BattleMoveAnims['chillingspell'] = { anim: BattleMoveAnims['sheercold'].anim };
BattleMoveAnims['psyscreen'] = { anim: BattleMoveAnims['confusion'].anim };
