...
filters.length;_i10++){var _ref8=filters[_i10];var filterType=_ref8[0];var value=_ref8[1];
switch(filterType){
case'type':
...
filters.length;_i14++){var _ref15=filters[_i14];var filterType=_ref15[0];var value=_ref15[1];
switch(filterType){
case'pokemon':
...
filters.length;_i18++){var _ref16=filters[_i18];var filterType=_ref16[0];var value=_ref16[1];
switch(filterType){
case'pokemon':
if(!Dex.hasAbility(this.dex.species.get(value),ability.name))return false;
break;
...
filters.length;_i28++){var _ref17=filters[_i28];var filterType=_ref17[0];var value=_ref17[1];
switch(filterType){
case'type':
